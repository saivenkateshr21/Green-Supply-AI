...
## 🌍 Hosting
For detailed hosting instructions on platforms like **Render**, **Firebase**, or **VPS**, please refer to the [DEPLOYMENT.md](./DEPLOYMENT.md) file.
...
## 📜 License
MIT License - Developed by Antigravity for GreenSupply AI.
